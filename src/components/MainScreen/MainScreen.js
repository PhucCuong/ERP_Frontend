    ...
    return (
        <div className="mainscreen_container">
            <Routes>
                ...
                <Route path="/reportings/cost" element={<ReportCost />} />
                <Route path="/reportings/overview" element={<ReportOverView />} />
                <Route path="/reportings/progress" element={<ReportProgress />} />
                <Route path="/reportings/quality" element={<ReportQuality />} />
